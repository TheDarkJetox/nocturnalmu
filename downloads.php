	...
	<div class="text">	
		...
		<div class="row">
			<div class="col-sm-12 border border-dark textbg">
				...
				<div class="row">
					<div class="col-sm-5 border btn text-white">
						<a target="_blank" class="text-white" href="../files/with_sound"><img src="../img/file.png" width="30%" /></a>
					</div>
					<div class="col-sm-2"></div>
					<div class="col-sm-5 border btn text-white">
						<a target="_blank" class="text-white" href="../files/without_sound"><img src="../img/file.png" width="30%" /></a>
					</div>
				</div>
			</div>
		</div>
