...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark">
		...
		<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
			...
			<li class="nav-item btn-dark">
				<a class="nav-link active" href="../staff.php">Staff List</a>
			</li>
			<li class="nav-item btn-dark">
	...
	<div class="text">	
		...
		<div class="row">
			<div class="col-sm-12 border border-dark textbg">
				...
				<div class="row">
					<div class="col-sm-1"></div>
					<div class="col-sm-4 border btn text-white">
						Name:
					</div>
					<div class="col-sm-6 border btn text-white">
						Role(s):
					</div>
					<div class="col-sm-1"></div>
				</div>
				<div class="row">
					<div class="col-sm-1"></div>
					<div class="col-sm-4 border btn text-white">
						<a class="text-white" href="../account/profile.php?user=TheDarkJetox" style="text-decoration: none">TheDarkJetox</a>
					</div>
					<div class="col-sm-6 border btn text-white">
						Server owner, Gamemaster
					</div>
					<div class="col-sm-1"></div>
				</div>
				<div class="row">
					<div class="col-sm-1"></div>
					<div class="col-sm-4 border btn text-white">
						<a class="text-white" href="../account/profile.php?user=noxworth" style="text-decoration: none">Zaveras/Noxworth</a>
					</div>
					<div class="col-sm-6 border btn text-white">
						Server admin, Gamemaster
					</div>
					<div class="col-sm-1"></div>
				</div>					
			</div>
