				...
				<?php }else{ ?>
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
						<form method="post" action="../account/login.php" class="container">
							...
							<button class="btn btn-dark" href="../account/register.php">Register</button>
						</form>
					</div>
				<?php } ?>
			</li>
			...
			<div class="col-sm-12 border border-dark textbg">
				...
				do { 
					if ($numOnline == 0) {
						...
						echo "<div class='col-sm-1 border'>
							#
						</div>
						<div class='col-sm-4 border'>
						...
						<div class='col-sm-4 border'>
							<a class='text-white' href='../account/profile.php?".$online[$i]['0']."'>".$online[$i]['0']."</a>
						</div>
						<div class='col-sm-3 border'>
							".$online[$i]['2']."
						</div>
